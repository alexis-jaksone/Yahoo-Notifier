...
app.popup = (function () {
  var callbacks = {},
      toolbarItem = safari.extension.toolbarItems[0];
      popup = safari.extension.createPopover("popover", safari.extension.baseURI + "data/popup/popup.html", 100, 100);
...
app.timer = window;
app.manifest = safari.extension.baseURI;
...
app.options = (function () {
  ...
  return {
    send: function (id, data) {
      safari.application.browserWindows.forEach(function (browserWindow) {
        browserWindow.tabs.forEach(function (tab) {
          if (tab.page && tab.url.indexOf("options/popup.html") !== -1) {
